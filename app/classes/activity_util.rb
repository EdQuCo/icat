class ActivityUtil
  def self.compute_calories(equation, cpm, bmi)
    case equation
      ...
      when 'FREEDSON_CMB'
        0.00094 * cpm + (0.1346 * bmi - 7.37418)
        #0.001064 * cpm + 0.087512 * bmi - 5.500229
      else
        cpm * 0.0000191 * bmi
    end
  ...
  def self.build_intensities(set)
    ...
    case set
      when 'FREEDSON_ADULT'
        ...
        intensities << Intensity.new('very vigorous', 9499, 999999)
      when 'FREEDSON_ADULT_VM3'
        ...
        intensities << Intensity.new('very vigorous', 9643, 999999)
      when 'FREEDSON_CHILDREN'
        ...
        intensities << Intensity.new('very vigorous', 7600, 999999)
      when 'PUYAU_CHILDREN'
